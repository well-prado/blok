...
const props = withDefaults(
	...
	{ variant: "wordmark", height: 24, title: undefined },
);

const mark = computed(() => props.variant === "mark");
const width = computed(() => (props.height * (mark.value ? 40 : 122)) / 32);
</script>
...
<template>
	...
	>
		...
		<path
			...
			fill="#2BCD71"
		/>
		<g v-if="!mark" fill="currentColor">
			<path
				d="M97.5879 23.8602V8.13977H102.079V14.8771H104.325V12.6313H106.571V10.3855H108.817V8.13977H113.308V10.3855H111.063V12.6313H108.817V14.8771H106.571V17.1229H108.817V19.3687H111.063V21.6144H113.308V23.8602H106.571V21.6144H104.325V19.3687H102.079V23.8602H97.5879Z"
			/>
			<path
				d="M81.8669 23.8602V21.6144H79.6211V10.3855H81.8669V8.13977H93.0958V10.3855H95.3416V21.6144H93.0958V23.8602H81.8669ZM84.1127 21.6144H90.85V10.3855H84.1127V21.6144Z"
			/>
			<path d="M65.6973 23.8602V8.13977H70.1888V21.6144H79.1719V23.8602H65.6973Z" />
			<path
				d="M48 23.8602V8.13977H61.4747V10.3855H63.7205V14.8771H61.4747V17.1229H63.7205V21.6144H61.4747V23.8602H48ZM52.4916 14.8771H59.2289V10.3855H52.4916V14.8771ZM52.4916 21.6144H59.2289V17.1229H52.4916V21.6144Z"
			/>
		</g>
	</svg>
</template>
