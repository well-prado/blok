...
module Nanoservice
  module Config
    ...
    class ServerConfig
      ...
      # @param version [String] Runtime version (default: Nanoservice::VERSION)
      ...
      def initialize(port: 8080, host: "0.0.0.0", version: nil,
        ...
        @port        = port
        @host        = host
        @version     = version || Nanoservice::VERSION
        @log_level   = log_level
      ...
      #   VERSION     - Runtime version (default: Nanoservice::VERSION)
      ...
      def self.from_env
        new(
          ...
          version:     ENV.fetch("VERSION", Nanoservice::VERSION),
