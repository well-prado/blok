...
import com.blok.blok.types.HealthStatus;
...
/**
 * HTTP server for the Blok blok runtime.
...
public class RuntimeServer {
    ...
    public void start() throws IOException {
        ...
        System.out.println("Blok runtime v" + config.getVersion()
    ...
    public void stop() {
        if (httpServer != null) {
            System.out.println("Shutting down blok runtime...");
