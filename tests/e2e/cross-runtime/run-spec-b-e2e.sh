...
# Go, Rust, C#, Java, Kotlin, PHP (via RoadRunner `rr`), Ruby (>= 3.1), Python3, Swift, Dart.
...
cd "$ROOT" && GO_GRPC_PORT=20001 RUST_GRPC_PORT=20002 JAVA_GRPC_PORT=20003 \
	CS_GRPC_PORT=20004 PHP_GRPC_PORT=20005 RUBY_GRPC_PORT=20006 PY_GRPC_PORT=20007 SWIFT_GRPC_PORT=20008 DART_GRPC_PORT=20009 KOTLIN_GRPC_PORT=20011 \
