...
import type { RuntimeKind, ExecutionResult } from '../../src/adapters/RuntimeAdapter';
 ...
 */
export function createMockNanoServiceResponse(success: boolean = true) {
  return {
    success,
 ...
 */
export function assertExecutionTimeWithinRange(
  actualMs: number,
  expectedMs: number,
