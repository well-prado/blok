 ...
 *
 * The Zod schemas, step-shape type-guards, and trigger validation machinery
 * live here. The author-facing surface (`workflow`, `branch`, `forEach`,
 * `loop`, `switchOn`, `tryCatch`, `eq`) stays on the main entry — these are
 * implementation details that tooling occasionally needs but workflow/node
 * authors never import.
 *
