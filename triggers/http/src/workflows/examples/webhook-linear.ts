			...
			cases: [
				{
					...
					do: [
						{
							id: "dispatch-issue",
							subworkflow: "webhook-linear-issue",
							inputs: {
								action: "js/ctx.request.body.action || null",
								data: "js/ctx.request.body.data || null",
								url: "js/ctx.request.body.url || null",
							},
						},
					],
				},
				{
					...
					do: [
						{
							id: "dispatch-comment",
							subworkflow: "webhook-linear-comment",
							inputs: {
								action: "js/ctx.request.body.action || null",
								data: "js/ctx.request.body.data || null",
								url: "js/ctx.request.body.url || null",
			...
			default: [
				{
					...
					inputs: {
						level: "warn",
						message:
							"js/`webhook-linear: unhandled type '${ctx.request.body.type || ''}' action='${ctx.request.body.action || ''}'`",
					},
				},
			],
		}),
