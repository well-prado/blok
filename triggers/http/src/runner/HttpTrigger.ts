...
export default class HttpTrigger extends TriggerBase {
	...
	/**
	 * #692 — live dispatch state, rebuilt by the same `buildFileBasedRoutes()`
	 * call that refreshes the #693 snapshot above, so the two views can
	 * never drift: `routeTable`/`bootRouting` answer "what should I tell a
	 * 404", `liveRoutes` answers "what do I dispatch right now".
