...
Status: inputs editor from catalog schemas, handle/value picker, and the branch condition editor all implemented on 2026-08-06. Remaining: the other control-flow editors (forEach/switch/tryCatch/wait/subworkflow) and Settings (as/spread/retry/idempotency).
