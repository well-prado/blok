...
- **#779 ships `src/hooks/useTableSort.ts` as the DEFAULT LOCAL owner** of sort state. E3 later replaces that hook with URL-derived state **at the call site**, touching zero E2 files.
