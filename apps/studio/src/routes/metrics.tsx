	...
	return (
		<div className="p-6 max-w-7xl mx-auto space-y-6">
			...
			<div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-3">
				...
				<MetricCard label="Completed" value={String(metrics.completedRuns)} color="text-green-400" />
				<MetricCard
					label="Failed"
				...
				<MetricCard label="P95 Duration" value={formatDuration(metrics.p95DurationMs)} />
				<MetricCard label="P99 Duration" value={formatDuration(metrics.p99DurationMs)} />
			</div>
