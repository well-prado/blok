...
import { Activity, BarChart3, Clock, Cpu, Grid3X3, Layers, List, Plus, TrendingUp, X } from "lucide-react";
		...
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
			...
			>
				...
				<div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
					...
					<button type="button" onClick={onClose} className="p-1 text-zinc-500 hover:text-zinc-300 transition-colors">
						<X className="w-4 h-4" />
					</button>
				</div>
				...
				<div className="p-4">
					{!selectedType ? (
						...
						<div className="space-y-4">
							...
							<div>
								<label htmlFor="widget-title" className="block text-xs font-medium text-zinc-400 mb-1">
									Title
								</label>
								<input
									id="widget-title"
							...
							{selectedType === "stat-card" && (
								<div>
									<label htmlFor="widget-metric" className="block text-xs font-medium text-zinc-400 mb-1">
										Metric
									</label>
									<select
										id="widget-metric"
