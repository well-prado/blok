...
function JsonNode({
	...
	if (typeof value === "number")
		return <JsonPrimitive keyName={keyName} value={String(value)} className="text-blue-400" />;
	if (typeof value === "boolean")
		return <JsonPrimitive keyName={keyName} value={String(value)} className="text-amber-400" />;
