...
export function RunsTable({ runs, total, page, limit, onPageChange, showWorkflow = false, enableCompare = false }: RunsTableProps) {
      ...
      {enableCompare && compareSelection.length > 0 && (
        <div className="mb-3 flex items-center gap-3 rounded-lg border border-zinc-800 bg-zinc-900/50 px-3 py-2">
          ...
          <span className="text-xs text-zinc-400">
            {compareSelection.length}/2 runs selected
          </span>
