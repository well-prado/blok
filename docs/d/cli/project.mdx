...
4. Pick any **observability modules** to enable (all optional — see [`blokctl observability`](./observability.mdx)).
5. **Select Example Installation: YES** (recommended for discovery and learning).
