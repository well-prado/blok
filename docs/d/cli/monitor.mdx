...
3. Run your blok application with docker:
   ```bash
...
After deploying your blok to Deskree Cloud:
...
These metrics help you identify bottlenecks, troubleshoot issues, and optimize your blok performance.
