...
| Node.js, Bun, and Deno execute the same portable `defineNode()` fixture successfully | `packages/js-runtime-worker/src/conformance/`; `packages/js-runtime-worker/tests/conformance.test.ts` (36 assertions, one fixture set, three engines) | Pass |
