...
- **Nodes can be written in 12 runtimes.** TypeScript runs in-process; the other 11 (\`go\`, \`rust\`, \`java\`, \`kotlin\`, \`csharp\`, \`php\`, \`ruby\`, \`python3\`, \`swift\`, \`dart\`, \`elixir\`) run as gRPC sidecar processes. A step routes to a sidecar via \`type: "runtime.<lang>"\`.

The 9 trigger types: \`http\`, \`worker\`, \`cron\`, \`pubsub\`, \`sse\`, \`websocket\`, \`webhook\`, \`mcp\`, \`grpc\`.
The 12 runtimes: \`typescript\` (in-process), \`go\`, \`rust\`, \`java\`, \`kotlin\`, \`csharp\`, \`php\`, \`ruby\`, \`python3\`, \`swift\`, \`dart\`, \`elixir\`.
...
- gRPC dispatch port = legacy HTTP port + 1000. **Dispatch ports:** go \`10001\`, rust \`10002\`, java \`10003\`, csharp \`10004\`, php \`10005\`, ruby \`10006\`, python3 \`10007\`, swift \`10008\`, dart \`10009\`, elixir \`10010\`, kotlin \`10011\`. (The CLI readiness check is a **TCP connect to the gRPC port**, not \`GET /health\`.)
...
blokctl create node <name> --runtime go  # Scaffold a node in another runtime (go|rust|java|csharp|php|ruby|python3|swift|dart)
