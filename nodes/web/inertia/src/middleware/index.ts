 ...
 *
 * RESERVED STEP IDS: `auth` and `flash`. Step ids are ONE flat namespace shared
 * with the page workflow (footgun 3), and middleware runs on the same ctx — so a
 * page step called `auth` would overwrite the shared user.
 */
